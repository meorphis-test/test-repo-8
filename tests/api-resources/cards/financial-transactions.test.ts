...
describe('resource financialTransactions', () => {
  test('getFinancialTransactionByToken', async () => {
    const responsePromise = meorphisTest6.cards.financialTransactions.getFinancialTransactionByToken(
  ...
  test('getFinancialTransactionByToken: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      meorphisTest6.cards.financialTransactions.getFinancialTransactionByToken(
        '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
        '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
